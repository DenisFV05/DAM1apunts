-- Packages, funciona pero da un par de avisos o errores que no entiendo exactamente que pueden ser.

CREATE OR REPLACE PACKAGE pkg_employees0525_Fernandez_Denis AS
...
END pkg_employees0525_Fernandez_Denis;
/

CREATE OR REPLACE PACKAGE BODY pkg_employees0525_Fernandez_Denis AS
...
CREATE OR REPLACE PACKAGE pkg_jobs0525_Fernandez_Denis AS
    FUNCTION f_job(nom jobs.job_title%type) RETURN jobs.job_id%type;
END pkg_jobs0525_Fernandez_Denis;
/

CREATE OR REPLACE PACKAGE BODY pkg_jobs0525_Fernandez_Denis AS
